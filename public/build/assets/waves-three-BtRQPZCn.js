import{b as e,n as t,p as n,t as r}from"./jsx-runtime-DXVQ-Whq.js";import{t as i}from"./button-BBKut1Er.js";import{t as a}from"./utils-BNhDZxi-.js";var o=e(n(),1),s=r(),c=20,l=`button-particle-styles-v2`;function u(e){if(typeof document>`u`)return;let t=document.getElementById(l),n=``,r=0;if(t){if(n=t.textContent||``,r=parseInt(t.dataset.maxIndex||`0`,10),r>=e)return}else t=document.createElement(`style`),t.id=l;t.dataset.maxIndex=String(e);let i=n;i||=`
        .bp-particle {
            position: absolute;
            border-radius: 50%;
            pointer-events: none;
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ro(e,t,n){let r=new Float32Array(wo),i=new q(0,1,0);return new aa({name:`SphericalGaussianBlur`,defines:{n:wo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Vo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function zo(){return new aa({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Vo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Bo(){return new aa({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Vo(),fragmentShader:`
	...
	`}var Ho=class extends sn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Bi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
        ...
        `,transparent:!0,depthWrite:!1})}function Il(e,t,n,r){return new aa({uniforms:{uSizeMin:{value:e},uSizeMax:{value:t},uAmp:{value:n},uOpacity:{value:r}},vertexShader:`
            attribute vec3  color;
            varying   vec3  vColor;
        ...
        `,transparent:!0,depthWrite:!1})}function Ll(e,t,n,r,i,a){let o=e+1,s=t+1,c=o*s,l=a/2,u=n/e,d=r/t,f=new Float32Array(c*3),p=new Float32Array(c*4*3),m=new Float32Array(c*4*3);for(let e=0;e<s;e++)for(let t=0;t<o;t++){let a=e*o+t,s=-n/2+t*u,h=-r/2+e*d;f[a*3]=s,f[a*3+1]=h,f[a*3+2]=0;let g=a*12;p[g]=s-l,p[g+1]=h,p[g+2]=0,p[g+3]=s+l,p[g+4]=h,p[g+5]=0,p[g+6]=s,p[g+7]=h-l,p[g+8]=0,p[g+9]=s,p[g+10]=h+l,p[g+11]=0;let _=kl(a/Math.max(c-1,1),i);for(let e=0;e<4;e++)m[g+e*3]=_.r,m[g+e*3+1]=_.g,m[g+e*3+2]=_.b}let h=new zr;return h.setAttribute(`position`,new Z(p,3)),h.setAttribute(`color`,new Z(m,3)),{geo:h,centers:f,pos:p}}function Rl(e,t,n,r,i,a){let o=e+1,s=t+1,c=jl(e,t,n,r),l=new Uint32Array(e*t*2),u=0;for(let n=0;n<t;n++)for(let t=0;t<e;t++)a===`right`?(l[u++]=n*o+t,l[u++]=(n+1)*o+t+1):(l[u++]=n*o+t+1,l[u++]=(n+1)*o+t);let d=new zr;return d.setAttribute(`position`,new Z(c,3)),d.setAttribute(`color`,new Z(Al(o*s,i),3)),d.setIndex(new Z(l,1)),{geo:d,pos:c}}function zl(e,t,n,r,i){let a=e+1,o=t+1,s=jl(e,t,n,r),c=t*e*2,l=new Uint32Array(c*2),u=0;for(let n=0;n<t;n++)for(let t=0;t<e;t++)n%2==0?(l[u++]=n*a+t,l[u++]=(n+1)*a+t+1,l[u++]=n*a+t+1,l[u++]=(n+1)*a+t+1):(l[u++]=n*a+t+1,l[u++]=(n+1)*a+t,l[u++]=n*a+t,l[u++]=(n+1)*a+t);let d=new zr;return d.setAttribute(`position`,new Z(s,3)),d.setAttribute(`color`,new Z(Al(a*o,i),3)),d.setIndex(new Z(l,1)),{geo:d,pos:s}}function Bl(e,t,n,r,i){let a=e,o=t,s=a*o,c=n/a/2,l=c*Math.sqrt(3),u=new Float32Array(s*12*3),d=new Float32Array(s*12*3),f=new Float32Array(s*3),p=0;for(let e=0;e<o;e++)for(let t=0;t<a;t++){let a=t%2==0?0:l*.5,o=-n/2+c+t*c*1.5,m=-r/2+l*.5+e*l+a;f[p*3]=o,f[p*3+1]=m,f[p*3+2]=0;let h=kl(p/Math.max(s-1,1),i),g=[];for(let e=0;e<6;e++){let t=Math.PI/3*e;g.push([o+c*Math.cos(t),m+c*Math.sin(t)])}for(let e=0;e<6;e++){let t=g[e],n=g[(e+1)%6],r=(p*6+e)*6;u[r]=t[0],u[r+1]=t[1],u[r+2]=0,u[r+3]=n[0],u[r+4]=n[1],u[r+5]=0;for(let e=0;e<2;e++)d[r+e*3]=h.r,d[r+e*3+1]=h.g,d[r+e*3+2]=h.b}p++}let m=new zr;return m.setAttribute(`position`,new Z(u.slice(0,p*6*6),3)),m.setAttribute(`color`,new Z(d.slice(0,p*6*6),3)),{geo:m,pos:u,hexCenters:f.slice(0,p*3)}}function Vl(e,t,n,r,i,a,o){let s=e+1,c=t+1,l=n/e,u=r/t,d=o/2,f=((a===`vertical`?0:c*e)+(a===`horizontal`?0:s*t))*2,p=new Float32Array(f*3),m=new Float32Array(f*3),h=new Float32Array(f*3),g=0,_=(e,t,n,r,a)=>{let o=kl(a/Math.max(s*c-1,1),i);for(let i=0;i<2;i++){let[a,s]=i===0?[e,t]:[n,r];p[g*3]=a,p[g*3+1]=s,p[g*3+2]=0,m[g*3]=a,m[g*3+1]=s,m[g*3+2]=0,h[g*3]=o.r,h[g*3+1]=o.g,h[g*3+2]=o.b,g++}};if(a!==`vertical`)for(let t=0;t<c;t++)for(let i=0;i<e;i++){let e=-n/2+i*l,a=e+l,o=-r/2+t*u;_(e+l*d,o,a-l*d,o,t*s+i)}if(a!==`horizontal`)for(let e=0;e<s;e++)for(let i=0;i<t;i++){let t=-r/2+i*u,a=t+u,o=-n/2+e*l;_(o,t+u*d,o,a-u*d,i*s+e)}let v=new zr;return v.setAttribute(`position`,new Z(p,3)),v.setAttribute(`color`,new Z(h,3)),{geo:v,pos:p,basePos:m}}function Hl(e,t,n,r,i,a){let o=e*t*4*2,s=new Float32Array(o*3),c=new Float32Array(o*3),l=new zr;return l.setAttribute(`position`,new Z(s,3).setUsage(tt)),l.setAttribute(`color`,new Z(c,3).setUsage(tt)),l.setDrawRange(0,0),{geo:l,vtxGrid:jl(e,t,n,r)}}function Ul(e,t,n,r,i){let a=new qi(n,r,e,t),o=a.attributes.position.count;return a.setAttribute(`color`,new Z(Al(o,i),3)),{geo:a,pos:a.attributes.position.array}}var Wl=e=>{let t=(0,p.c)(68),{className:n,style:r,lines:i,colors:c,cameraPosition:l,planeWidth:u,planeHeight:d,segmentsX:f,segmentsY:m,speed:h,amplitude:g,frequency:_,opacity:v,paused:y,mouseInfluence:b,mouseRotation:x,dotSize:S,dotSizeMin:C,crossSize:w,dashRatio:T,contourLevels:E,maxPixelRatio:D,onReady:O}=e,k=r===void 0?`grid`:r,A=i===void 0?`both`:i,j;t[0]===l?j=t[1]:(j=l===void 0?{x:0,y:0,z:10}:l,t[0]=l,t[1]=j);let M=j,N=u===void 0?80:u,P=d===void 0?40:d,ee=f===void 0?60:f,te=m===void 0?30:m,ne=h===void 0?1:h,F=g===void 0?1.5:g,re=_===void 0?.3:_,ie=v===void 0?.6:v,I=y===void 0?!1:y,ae=b===void 0?2:b,oe=x===void 0?.1:x,se=S===void 0?3:S,ce=C===void 0?1:C,le=w===void 0?.3:w,ue=T===void 0?.5:T,de=E===void 0?6:E,fe=D===void 0?2:D,pe=(0,o.useRef)(null),L;t[2]===Symbol.for(`react.memo_cache_sentinel`)?(L={width:0,height:0},t[2]=L):L=t[2];let[me,he]=(0,o.useState)(L),ge;t[3]===Symbol.for(`react.memo_cache_sentinel`)?(ge={x:0,y:0},t[3]=ge):ge=t[3];let _e=(0,o.useRef)(ge),ve=(0,o.useRef)(ne),ye=(0,o.useRef)(I),be=(0,o.useRef)(F),xe=(0,o.useRef)(re),Se=(0,o.useRef)(ae),Ce=(0,o.useRef)(oe),we=(0,o.useRef)(ie),Te,Ee;t[4]===ne?(Te=t[5],Ee=t[6]):(Te=()=>{ve.current=ne},Ee=[ne],t[4]=ne,t[5]=Te,t[6]=Ee),(0,o.useEffect)(Te,Ee);let De,R;t[7]===I?(De=t[8],R=t[9]):(De=()=>{ye.current=I},R=[I],t[7]=I,t[8]=De,t[9]=R),(0,o.useEffect)(De,R);let Oe,z;t[10]===F?(Oe=t[11],z=t[12]):(Oe=()=>{be.current=F},z=[F],t[10]=F,t[11]=Oe,t[12]=z),(0,o.useEffect)(Oe,z);let ke,B;t[13]===re?(ke=t[14],B=t[15]):(ke=()=>{xe.current=re},B=[re],t[13]=re,t[14]=ke,t[15]=B),(0,o.useEffect)(ke,B);let Ae,V;t[16]===ae?(Ae=t[17],V=t[18]):(Ae=()=>{Se.current=ae},V=[ae],t[16]=ae,t[17]=Ae,t[18]=V),(0,o.useEffect)(Ae,V);let H,je;t[19]===oe?(H=t[20],je=t[21]):(H=()=>{Ce.current=oe},je=[oe],t[19]=oe,t[20]=H,t[21]=je),(0,o.useEffect)(H,je);let Me,Ne;t[22]===ie?(Me=t[23],Ne=t[24]):(Me=()=>{we.current=ie},Ne=[ie],t[22]=ie,t[23]=Me,t[24]=Ne),(0,o.useEffect)(Me,Ne);let Pe,Fe;t[25]===Symbol.for(`react.memo_cache_sentinel`)?(Pe=()=>{let e=pe.current;if(!e)return;let t=new ResizeObserver(e=>{let t=e[0].contentRect;he({width:t.width,height:t.height})});return t.observe(e),()=>t.disconnect()},Fe=[],t[25]=Pe,t[26]=Fe):(Pe=t[25],Fe=t[26]),(0,o.useEffect)(Pe,Fe);let Ie;t[27]!==F||t[28]!==M||t[29]!==c||t[30]!==de||t[31]!==le||t[32]!==ue||t[33]!==se||t[34]!==ce||t[35]!==A||t[36]!==fe||t[37]!==O||t[38]!==P||t[39]!==N||t[40]!==ee||t[41]!==te||t[42]!==me.height||t[43]!==me.width||t[44]!==k?(Ie=()=>{let e=pe.current;if(!e||me.width===0||me.height===0)return;let t=new Kn,n=new Ra(75,me.width/me.height,.1,1e3);n.position.set(M.x,M.y,M.z),n.lookAt(0,0,0);let r=new El({alpha:!0,antialias:!0});r.setPixelRatio(Math.min(window.devicePixelRatio,fe)),r.setSize(me.width,me.height),r.setClearColor(0,0),e.appendChild(r.domElement);let i=document.documentElement.classList.contains(`dark`),a=(c??(i?Ol:Dl)).map(Gl),o,s,l,u=null,d=null,f=null,p=null,m=null,h=null,g=null,_=[],v=[],y=ee,b=te;if(k===`wireframe`){let e=new qi(N,P,y,b);e.setAttribute(`color`,new Z(Al(e.attributes.position.count,a),3));let t=new Xr({vertexColors:!0,wireframe:!0,transparent:!0,opacity:we.current});o=new ci(e,t),f=e.attributes.position,u=f.array,s=e,l=t}else if(k===`grid`){let{geo:e,pos:t}=Nl(y,b,N,P,a,A),n=new bi({vertexColors:!0,transparent:!0,opacity:we.current});o=new Mi(e,n),f=e.attributes.position,u=t,s=e,l=n}else if(k===`dots`){let{geo:e,pos:t}=Pl(y,b,N,P,a),n=Fl(se*2,we.current);o=new Ri(e,n),f=e.attributes.position,u=t,s=e,l=n}else if(k===`dots-wave`){let{geo:e,pos:t}=Pl(y,b,N,P,a),n=Il(ce*2,se*2,F,we.current);o=new Ri(e,n),f=e.attributes.position,u=t,s=e,l=n}else if(k===`crosses`){let{geo:e,centers:t,pos:n}=Ll(y,b,N,P,a,le),r=new bi({vertexColors:!0,transparent:!0,opacity:we.current});o=new Mi(e,r),f=e.attributes.position,u=n,p=t,s=e,l=r}else if(k===`diagonal-left`||k===`diagonal-right`){let{geo:e,pos:t}=Rl(y,b,N,P,a,k===`diagonal-left`?`left`:`right`),n=new bi({vertexColors:!0,transparent:!0,opacity:we.current});o=new Mi(e,n),f=e.attributes.position,u=t,s=e,l=n}else if(k===`zigzag`){let{geo:e,pos:t}=zl(y,b,N,P,a),n=new bi({vertexColors:!0,transparent:!0,opacity:we.current});o=new Mi(e,n),f=e.attributes.position,u=t,s=e,l=n}else if(k===`hexagons`){let{geo:e,pos:t,hexCenters:n}=Bl(y,b,N,P,a),r=new bi({vertexColors:!0,transparent:!0,opacity:we.current});o=new Mi(e,r),f=e.attributes.position,h=t,m=n,s=e,l=r}else if(k===`dashes`){let{geo:e,pos:t,basePos:n}=Vl(y,b,N,P,a,A,ue),r=new bi({vertexColors:!0,transparent:!0,opacity:we.current});o=new Mi(e,r),f=e.attributes.position,u=t,d=n,s=e,l=r}else if(k===`contour`){let{geo:e,vtxGrid:t}=Hl(y,b,N,P,a,de),n=new bi({vertexColors:!0,transparent:!0,opacity:we.current});o=new Mi(e,n),f=e.attributes.position,g=t,s=e,l=n}else{let{geo:e,pos:n}=Ul(y,b,N,P,a),r=new sa({vertexColors:!0,transparent:!0,opacity:we.current,side:2,shininess:60}),i=new Va(16777215,1.2);i.position.set(5,10,7);let c=new Ha(16777215,.4);t.add(i,c),v=[i,c],o=new ci(e,r),f=e.attributes.position,u=n,s=e,l=r}t.add(o);let x=()=>{n.aspect=e.clientWidth/e.clientHeight,n.updateProjectionMatrix(),r.setSize(e.clientWidth,e.clientHeight)},S=e=>{_e.current.x=e.clientX/window.innerWidth*2-1,_e.current.y=-(e.clientY/window.innerHeight)*2+1};window.addEventListener(`resize`,x),window.addEventListener(`mousemove`,S);let C=(e,t,n,r,i)=>{let s=y+1,c=0,l=r.array,u=i.array;for(let r of n){let n=kl((r-(-F-1))/((F+1)*2),a);for(let i=0;i<b;i++)for(let a=0;a<y;a++){let o=i*s+a,d=i*s+a+1,f=(i+1)*s+a,p=(i+1)*s+a+1,m=t[o],h=t[d],g=t[f],_=t[p],v=e[o*3],y=e[o*3+1],b=e[d*3],x=e[d*3+1],S=e[f*3],C=e[f*3+1],w=e[p*3],T=e[p*3+1],E=[],D=(e,t,n,i,a,o,s,c)=>{if(e<r!=t<r){let a=(r-e)/(t-e);E.push([n+(o-n)*a,i+(s-i)*a,r])}};if(D(m,h,v,y,m,b,x,h),D(h,_,b,x,h,w,T,_),D(g,_,S,C,g,w,T,_),D(m,g,v,y,m,S,C,g),E.length>=2&&c+6<=l.length)for(let e=0;e<2;e++)l[c]=E[e][0],l[c+1]=E[e][1],l[c+2]=E[e][2],u[c]=n.r,u[c+1]=n.g,u[c+2]=n.b,c+=3}}r.needsUpdate=!0,i.needsUpdate=!0,o.geometry.setDrawRange(0,c/3)},w=k===`contour`?new Float32Array((y+1)*(b+1)):null,T,E=()=>{if(T=requestAnimationFrame(E),l.opacity!==void 0&&(l.opacity=we.current),l.uniforms?.uOpacity&&(l.uniforms.uOpacity.value=we.current),!ye.current){let e=performance.now()*.001*ve.current,t=xe.current,n=be.current,r=Se.current,i=_e.current.x,a=_e.current.y;if(k===`crosses`&&p&&f&&u){let o=(y+1)*(b+1);for(let s=0;s<o;s++){let o=p[s*3],c=p[s*3+1],l=Ml(o,c,e,t,n,i,a,r),d=s*12;u[d+2]=l,u[d+5]=l,u[d+8]=l,u[d+11]=l}f.needsUpdate=!0}else if(k===`hexagons`&&m&&h&&f){let o=m.length/3;for(let s=0;s<o;s++){let o=m[s*3],c=m[s*3+1],l=Ml(o,c,e,t,n,i,a,r),u=s*6*6;for(let e=0;e<12;e++)h[u+e*3+2]=l}let c=s.attributes.position,l=c.array;l.set(h.slice(0,l.length)),c.needsUpdate=!0}else if(k===`dashes`&&u&&d&&f){let o=u.length/3;for(let s=0;s<o;s++){let o=d[s*3],c=d[s*3+1];u[s*3+2]=Ml(o,c,e,t,n,i,a,r)}f.needsUpdate=!0}else if(k===`contour`&&g&&w&&f){let o=(y+1)*(b+1);for(let s=0;s<o;s++){let o=g[s*3],c=g[s*3+1];w[s]=Ml(o,c,e,t,n,i,a,r)}let c=[];for(let e=0;e<de;e++)c.push(-n-1+e/(de-1)*(n+1)*2);C(g,w,c,s.attributes.position,s.attributes.color)}else if(u&&f){let o=u.length/3;for(let s=0;s<o;s++){let o=u[s*3],c=u[s*3+1];u[s*3+2]=Ml(o,c,e,t,n,i,a,r)}f.needsUpdate=!0,k===`solid`&&s.computeVertexNormals()}o.rotation.x=a*Ce.current,o.rotation.y=i*Ce.current}r.render(t,n)};return E(),O?.(),()=>{cancelAnimationFrame(T),window.removeEventListener(`resize`,x),window.removeEventListener(`mousemove`,S),v.forEach(e=>t.remove(e)),t.remove(o),s.dispose(),l.dispose(),_.forEach(Kl),r.dispose(),e.contains(r.domElement)&&e.removeChild(r.domElement)}},t[27]=F,t[28]=M,t[29]=c,t[30]=de,t[31]=le,t[32]=ue,t[33]=se,t[34]=ce,t[35]=A,t[36]=fe,t[37]=O,t[38]=P,t[39]=N,t[40]=ee,t[41]=te,t[42]=me.height,t[43]=me.width,t[44]=k,t[45]=Ie):Ie=t[45];let Le;t[46]!==M||t[47]!==c||t[48]!==de||t[49]!==le||t[50]!==ue||t[51]!==se||t[52]!==ce||t[53]!==A||t[54]!==fe||t[55]!==O||t[56]!==P||t[57]!==N||t[58]!==ee||t[59]!==te||t[60]!==me.height||t[61]!==me.width||t[62]!==k?(Le=[me.width,me.height,k,c,A,M,N,P,ee,te,se,ce,le,ue,de,fe,O],t[46]=M,t[47]=c,t[48]=de,t[49]=le,t[50]=ue,t[51]=se,t[52]=ce,t[53]=A,t[54]=fe,t[55]=O,t[56]=P,t[57]=N,t[58]=ee,t[59]=te,t[60]=me.height,t[61]=me.width,t[62]=k,t[63]=Le):Le=t[63],(0,o.useEffect)(Ie,Le);let Re;t[64]===n?Re=t[65]:(Re=a(`pointer-events-none absolute inset-0`,n),t[64]=n,t[65]=Re);let ze;return t[66]===Re?ze=t[67]:(ze=(0,s.jsx)(`div`,{ref:pe,className:Re,"aria-hidden":`true`}),t[66]=Re,t[67]=ze),ze};function Gl(e){return new X(e)}function Kl(e){return e.dispose()}export{Ji as A,Ri as C,Yr as D,ie as E,K as F,q as I,sn as L,h as M,Yi as N,Kn as O,Xi as P,f as R,qi as S,Vt as T,Xr as _,zr as a,Ra as b,so as c,Rn as d,Ki as f,ci as g,Bt as h,Z as i,oo as j,aa as k,Va as l,m,El as n,ao as o,S as p,Ha as r,X as s,Wl as t,Dr as u,sa as v,Ni as w,hi as x,za as y};