...
class AnimateSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach (static::animations() as $animation) {
            Animate::create(array_merge($animation, ['user_id' => 1]));
            $total++;
        }
    ...
    public static function animations(): array
    {
        return [
            [
                ...
                'description' => null,
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-bounce' => 'bounce 1s'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes bounce' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-pulse' => 'pulse 2s cubic-bezier(0.4, 0, 0.6, 1) infinite'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes pulse' => [
                            '0%, 100%' => ['opacity' => '1'],
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-flash' => 'flash 1s'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes flash' => [
                            '0%, 50%, 100%' => ['opacity' => '1'],
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-wobble' => 'wobble 1s ease-in-out'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes wobble' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-rubber-band' => 'rubberBand 1s'],
                'css' => [
                    '@layer utilities' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-shake' => 'shake 1s'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes shake' => [
                            '0%, 100%' => ['transform' => 'translateX(0)'],
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-head-shake' => 'headShake 1s ease-in-out'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes headShake' => [
                            '0%' => ['transform' => 'translateX(0)'],
                            '6.5%' => ['transform' => 'translateX(-6px) rotate(-6deg)'],
                            '18.5%' => ['transform' => 'translateX(5px) rotate(6deg)'],
                            '31.5%' => ['transform' => 'translateX(-3px) rotate(-3deg)'],
                            '43.5%' => ['transform' => 'translateX(2px) rotate(2deg)'],
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-swing' => 'swing 1s'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes swing' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-jello' => 'jello 1s'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes jello' => [
                            '0%' => ['transform' => 'scale3d(1, 1, 1)'],
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-heart-beat' => 'heartBeat 1s'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes heartBeat' => [
                            '0%' => ['transform' => 'scale(1)'],
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-flip' => 'flip 1s ease-in-out'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes flip' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-flip-in-x' => 'flipInX 1s'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes flipInX' => [
                            '0%' => ['transform' => 'perspective(400px) rotate3d(1, 0, 0, 90deg)', 'opacity' => '0'],
                            '40%' => ['transform' => 'perspective(400px) rotate3d(1, 0, 0, -20deg)', 'animation-timing-function' => 'ease-out'],
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-flip-in-y' => 'flipInY 1s'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes flipInY' => [
                            '0%' => ['transform' => 'perspective(400px) rotate3d(0, 1, 0, 90deg)', 'opacity' => '0'],
                            '40%' => ['transform' => 'perspective(400px) rotate3d(0, 1, 0, -20deg)', 'animation-timing-function' => 'ease-out'],
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-flip-out-x' => 'flipOutX 1s'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes flipOutX' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-flip-out-y' => 'flipOutY 1s'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes flipOutY' => [
                            '0%' => ['transform' => 'perspective(400px)'],
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-fade-in' => 'fadeIn 1s'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes fadeIn' => [
                            '0%' => ['opacity' => '0'],
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-fade-in-down' => 'fadeInDown 1s'],
                'css' => [
                    '@layer utilities' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-fade-in-down-big' => 'fadeInDownBig 1s'],
                'css' => [
                    '@layer utilities' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-fade-in-left' => 'fadeInLeft 1s'],
                'css' => [
                    '@layer utilities' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-fade-in-left-big' => 'fadeInLeftBig 1s'],
                'css' => [
                    '@layer utilities' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-fade-in-right' => 'fadeInRight 1s'],
                'css' => [
                    '@layer utilities' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-fade-in-right-big' => 'fadeInRightBig 1s'],
                'css' => [
                    '@layer utilities' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-fade-in-up' => 'fadeInUp 1s'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes fadeInUp' => [
                            '0%' => ['opacity' => '0', 'transform' => 'translate3d(0, 100%, 0)'],
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-fade-in-up-big' => 'fadeInUpBig 1s'],
                'css' => [
                    '@layer utilities' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-fade-out' => 'fadeOut 1s'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes fadeOut' => [
                            '0%' => ['opacity' => '1'],
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-fade-out-down' => 'fadeOutDown 1s'],
                'css' => [
                    '@layer utilities' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-fade-out-down-big' => 'fadeOutDownBig 1s'],
                'css' => [
                    '@layer utilities' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-fade-out-left' => 'fadeOutLeft 1s'],
                'css' => [
                    '@layer utilities' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-fade-out-left-big' => 'fadeOutLeftBig 1s'],
                'css' => [
                    '@layer utilities' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-fade-out-right' => 'fadeOutRight 1s'],
                'css' => [
                    '@layer utilities' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-fade-out-right-big' => 'fadeOutRightBig 1s'],
                'css' => [
                    '@layer utilities' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-fade-out-up' => 'fadeOutUp 1s'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes fadeOutUp' => [
                            '0%' => ['opacity' => '1'],
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-fade-out-up-big' => 'fadeOutUpBig 1s'],
                'css' => [
                    '@layer utilities' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-slide-in-down' => 'slideInDown 1s'],
                'css' => [
                    '@layer utilities' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-slide-in-left' => 'slideInLeft 1s'],
                'css' => [
                    '@layer utilities' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-slide-in-right' => 'slideInRight 1s'],
                'css' => [
                    '@layer utilities' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-slide-in-up' => 'slideInUp 1s'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes slideInUp' => [
                            '0%' => ['transform' => 'translate3d(0, 100%, 0)', 'visibility' => 'visible'],
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-slide-out-down' => 'slideOutDown 1s'],
                'css' => [
                    '@layer utilities' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-slide-out-left' => 'slideOutLeft 1s'],
                'css' => [
                    '@layer utilities' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-slide-out-right' => 'slideOutRight 1s'],
                'css' => [
                    '@layer utilities' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-slide-out-up' => 'slideOutUp 1s'],
                'css' => [
                    '@layer utilities' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-zoom-in' => 'zoomIn 1s'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes zoomIn' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-zoom-in-down' => 'zoomInDown 1s'],
                'css' => [
                    '@layer utilities' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-zoom-in-left' => 'zoomInLeft 1s'],
                'css' => [
                    '@layer utilities' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-zoom-in-right' => 'zoomInRight 1s'],
                'css' => [
                    '@layer utilities' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-zoom-in-up' => 'zoomInUp 1s'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes zoomInUp' => [
                            '0%' => ['opacity' => '0', 'transform' => 'scale3d(0.1, 0.1, 0.1) translate3d(0, 1000px, 0)', 'animation-timing-function' => 'cubic-bezier(0.55, 0.055, 0.675, 0.19)'],
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-zoom-out' => 'zoomOut 1s'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes zoomOut' => [
                            '0%' => ['opacity' => '1'],
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-zoom-out-down' => 'zoomOutDown 1s'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes zoomOutDown' => [
                            ...
                            '100%' => ['opacity' => '0', 'transform' => 'scale3d(0.1, 0.1, 0.1) translate3d(0, 1000px, 0)', 'transform-origin' => 'center bottom'],
                        ],
                    ],
                ],
                'registryDependencies' => null,
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-zoom-out-left' => 'zoomOutLeft 1s'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes zoomOutLeft' => [
                            '40%' => ['opacity' => '1', 'transform' => 'scale3d(0.475, 0.475, 0.475) translate3d(42px, 0, 0)'],
                            '100%' => ['opacity' => '0', 'transform' => 'scale(0.1) translate3d(-1000px, 0, 0)', 'transform-origin' => 'left center'],
                        ],
                    ],
                ],
                'registryDependencies' => null,
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-zoom-out-right' => 'zoomOutRight 1s'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes zoomOutRight' => [
                            '40%' => ['opacity' => '1', 'transform' => 'scale3d(0.475, 0.475, 0.475) translate3d(-42px, 0, 0)'],
                            '100%' => ['opacity' => '0', 'transform' => 'scale(0.1) translate3d(1000px, 0, 0)', 'transform-origin' => 'right center'],
                        ],
                    ],
                ],
                'registryDependencies' => null,
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-zoom-out-up' => 'zoomOutUp 1s'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes zoomOutUp' => [
                            '40%' => ['opacity' => '1', 'transform' => 'scale3d(0.475, 0.475, 0.475) translate3d(0, 60px, 0)', 'animation-timing-function' => 'cubic-bezier(0.55, 0.055, 0.675, 0.19)'],
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-rotate-in' => 'rotateIn 1s'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes rotateIn' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-rotate-out' => 'rotateOut 1s'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes rotateOut' => [
                            '0%' => ['transform' => 'rotate3d(0, 0, 1, 0deg)', 'opacity' => '1'],
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-roll-in' => 'rollIn 1s'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes rollIn' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-roll-out' => 'rollOut 1s'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes rollOut' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-light-speed-in' => 'lightSpeedInRight 1s ease-out'],
                'css' => [
                    '@layer utilities' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-light-speed-out' => 'lightSpeedOutLeft 1s ease-in'],
                'css' => [
                    '@layer utilities' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-jack-in-box' => 'jackInTheBox 1s'],
                'css' => [
                    '@layer utilities' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-hinge' => 'hinge 2s'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes hinge' => [
                            '0%' => ['transform' => 'rotate3d(0, 0, 1, 0deg)', 'transform-origin' => 'top left', 'animation-timing-function' => 'ease-in-out'],
                            '20%, 60%' => ['transform' => 'rotate3d(0, 0, 1, 80deg)', 'transform-origin' => 'top left', 'animation-timing-function' => 'ease-in-out'],
                            '40%, 80%' => ['transform' => 'rotate3d(0, 0, 1, 60deg)', 'transform-origin' => 'top left', 'animation-timing-function' => 'ease-in-out'],
                            '100%' => ['transform' => 'rotate3d(0, 0, 1, 90deg)', 'transform-origin' => 'top left', 'opacity' => '0'],
                        ],
                    ],
                ],
                'registryDependencies' => null,
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-bounce-in' => 'bounceIn 0.75s'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes bounceIn' => [
                            '0%' => ['opacity' => '0', 'transform' => 'scale3d(0.3, 0.3, 0.3)'],
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-bounce-in-down' => 'bounceInDown 1s'],
                'css' => [
                    '@layer utilities' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-bounce-in-left' => 'bounceInLeft 1s'],
                'css' => [
                    '@layer utilities' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-bounce-in-right' => 'bounceInRight 1s'],
                'css' => [
                    '@layer utilities' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-bounce-in-up' => 'bounceInUp 1s'],
                'css' => [
                    '@layer utilities' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-bounce-out' => 'bounceOut 0.75s'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes bounceOut' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-bounce-out-down' => 'bounceOutDown 1s'],
                'css' => [
                    '@layer utilities' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-bounce-out-left' => 'bounceOutLeft 1s'],
                'css' => [
                    '@layer utilities' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-bounce-out-right' => 'bounceOutRight 1s'],
                'css' => [
                    '@layer utilities' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-bounce-out-up' => 'bounceOutUp 1s'],
                'css' => [
                    '@layer utilities' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-back-in-down' => 'backInDown 1s'],
                'css' => [
                    '@layer utilities' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-back-in-left' => 'backInLeft 1s'],
                'css' => [
                    '@layer utilities' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-back-in-right' => 'backInRight 1s'],
                'css' => [
                    '@layer utilities' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-back-in-up' => 'backInUp 1s'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes backInUp' => [
                            '0%' => ['transform' => 'translateY(1200px) scale(0.7)', 'opacity' => '0.7'],
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-back-out-down' => 'backOutDown 1s'],
                'css' => [
                    '@layer utilities' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-back-out-left' => 'backOutLeft 1s'],
                'css' => [
                    '@layer utilities' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-back-out-right' => 'backOutRight 1s'],
                'css' => [
                    '@layer utilities' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-back-out-up' => 'backOutUp 1s'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes backOutUp' => [
                            '0%' => ['transform' => 'scale(1)', 'opacity' => '1'],
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-rotate-in-down-left' => 'rotateInDownLeft 1s'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes rotateInDownLeft' => [
                            '0%' => ['transform' => 'rotate3d(0, 0, 1, -45deg)', 'opacity' => '0', 'transform-origin' => 'left bottom'],
                            '100%' => ['transform' => 'rotate3d(0, 0, 1, 0deg)', 'opacity' => '1', 'transform-origin' => 'left bottom'],
                        ],
                    ],
                ],
                'registryDependencies' => null,
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-rotate-in-down-right' => 'rotateInDownRight 1s'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes rotateInDownRight' => [
                            '0%' => ['transform' => 'rotate3d(0, 0, 1, 45deg)', 'opacity' => '0', 'transform-origin' => 'right bottom'],
                            '100%' => ['transform' => 'rotate3d(0, 0, 1, 0deg)', 'opacity' => '1', 'transform-origin' => 'right bottom'],
                        ],
                    ],
                ],
                'registryDependencies' => null,
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-rotate-in-up-left' => 'rotateInUpLeft 1s'],
                'css' => [
                    '@layer utilities' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-rotate-in-up-right' => 'rotateInUpRight 1s'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes rotateInUpRight' => [
                            '0%' => ['transform' => 'rotate3d(0, 0, 1, -90deg)', 'opacity' => '0', 'transform-origin' => 'right bottom'],
                            '100%' => ['transform' => 'rotate3d(0, 0, 1, 0deg)', 'opacity' => '1', 'transform-origin' => 'right bottom'],
                        ],
                    ],
                ],
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-rotate-out-down-left' => 'rotateOutDownLeft 1s'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes rotateOutDownLeft' => [
                            '0%' => ['opacity' => '1', 'transform-origin' => 'left bottom'],
                            '100%' => ['transform' => 'rotate3d(0, 0, 1, 45deg)', 'opacity' => '0', 'transform-origin' => 'left bottom'],
                        ],
                    ],
                ],
                'registryDependencies' => null,
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-rotate-out-down-right' => 'rotateOutDownRight 1s'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes rotateOutDownRight' => [
                            '0%' => ['opacity' => '1', 'transform-origin' => 'right bottom'],
                            '100%' => ['transform' => 'rotate3d(0, 0, 1, -45deg)', 'opacity' => '0', 'transform-origin' => 'right bottom'],
                        ],
                    ],
                ],
                'registryDependencies' => null,
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-rotate-out-up-left' => 'rotateOutUpLeft 1s'],
                'css' => [
                    '@layer utilities' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-rotate-out-up-right' => 'rotateOutUpRight 1s'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes rotateOutUpRight' => [
                            '0%' => ['opacity' => '1', 'transform-origin' => 'right bottom'],
                            '100%' => ['transform' => 'rotate3d(0, 0, 1, 90deg)', 'opacity' => '0', 'transform-origin' => 'right bottom'],
                        ],
                    ],
                ],
                'registryDependencies' => null,
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-float' => 'float 3s ease-in-out infinite'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes float' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-spin' => 'spin 1s linear infinite'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes spin' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-wiggle' => 'wiggle 0.8s ease-in-out infinite'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes wiggle' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-ping' => 'ping 1s cubic-bezier(0, 0, 0.2, 1) infinite'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes ping' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-blur-in' => 'blurIn 0.6s ease-out'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes blurIn' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-blur-out' => 'blurOut 0.6s ease-in'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes blurOut' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-glitch' => 'glitch 0.6s steps(1) infinite'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes glitch' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-pop' => 'pop 0.4s cubic-bezier(0.26, 0.53, 0.74, 1.48)'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes pop' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-compress' => 'compress 0.5s ease-in-out'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes compress' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-expand' => 'expand 0.5s cubic-bezier(0.175, 0.885, 0.32, 1.275)'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes expand' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-drop' => 'drop 0.6s ease-out'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes drop' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-sway' => 'sway 2s ease-in-out infinite'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes sway' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-ken-burns' => 'kenBurns 8s ease-in-out infinite alternate'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes kenBurns' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-tilt' => 'tilt 1.5s ease-in-out infinite alternate'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes tilt' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-ring' => 'ring 0.5s ease-in-out'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes ring' => [
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-alarm' => 'alarm 0.8s ease-in-out'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes alarm' => [
                            '0%, 100%' => ['transform' => 'rotate(0deg) scale(1)'],
                            '10%, 30%' => ['transform' => 'rotate(-25deg) scale(1.05)'],
                            '20%, 40%' => ['transform' => 'rotate(25deg) scale(1.05)'],
                            '50%, 70%' => ['transform' => 'rotate(-15deg) scale(1.02)'],
                            '60%, 80%' => ['transform' => 'rotate(15deg) scale(1.02)'],
                        ],
                    ],
                ],
                'registryDependencies' => null,
            ...
            [
                ...
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => ['--animate-bell' => 'bell 1s ease-in-out'],
                'css' => [
                    '@layer utilities' => [
                        '@keyframes bell' => [
            ...
            [
                'name' => 'animate-all',
                'title' => 'Animate All',
                'description' => 'Install all 103 animation utilities',
                'author' => 'designbycode',
                'meta' => ['category' => 'animations', 'version' => '1.0.0'],
                'css_vars' => null,
                'css' => null,
